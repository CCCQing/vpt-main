...
def main() -> None:
    ...
    def _add_trial(
        *,
        ...
        opts = [
            ...
            "MODEL.SEMANTIC_GRAPH.LOSS_TYPE", "fgw",
            "MODEL.SEMANTIC_GRAPH.LOSS_WEIGHT", str(graph_loss_weight),
        ]
        trials.append(
            {
                "group": "attention_mediation_72",
    ...
    for attention_source in ["probs", "scores"]:
    ...
    search_space = {
        ...
        "fixed_setting": {
            ...
            "MODEL.ATTENTION_MEDIATION.BETA_PROMPT_MASS": 1.0,
            "MODEL.ATTENTION_MEDIATION.BETA_SEMANTIC_MASS": 1.0,
            "MODEL.ATTENTION_MEDIATION.SOURCE": "trial_specific",
            "MODEL.ATTENTION_MEDIATION.EXECUTION_MODE": "trial_specific",
            "MODEL.ATTENTION_MEDIATION.MLP_POLICY": "trial_specific",
            "MODEL.ATTENTION_MEDIATION.ROUTE_SCOPE": "trial_specific",
            "MODEL.ATTENTION_MEDIATION.MASS_MODE": "trial_specific",
            "MODEL.ATTENTION_MEDIATION.PROMPT_ROUTE": "trial_specific",
            "MODEL.ATTENTION_MEDIATION.SEMANTIC_ROUTE": "trial_specific",
            "DATA.BATCH_SIZE": 64,
            "SOLVER.BASE_LR": 0.00125,
            "SOLVER.TOTAL_EPOCH": 40,
            "SOLVER.WARMUP_EPOCH": 3,
    ...
    def _build_trial(idx: int, trial: Dict[str, object], gpu_id: str = ""):
        ...
        row: Dict[str, object] = {
            ...
            "attention_mediation_enable": trial["attention_mediation_enable"],
            "attention_source": trial["attention_source"],
            "execution_mode": trial["execution_mode"],
            "mlp_policy": trial["mlp_policy"],
            "route_scope": trial["route_scope"],
            "mass_mode": trial["mass_mode"],
            "prompt_route": trial["prompt_route"],
            "semantic_route": trial["semantic_route"],
            "beta_prompt_mass": trial["beta_prompt_mass"],
            "beta_semantic_mass": trial["beta_semantic_mass"],
            "gpu": gpu_id,
            "exit_code": -1,
            "run_dir": "",
        }
