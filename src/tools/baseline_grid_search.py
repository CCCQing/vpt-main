...
def main() -> None:
    ...
    def _add_trial(
        *,
        ...
        prompt_mode: str,
        prompt_backend: str,
        affinity_evolution_enable: bool,
        prompt_lambda: float,
        semantic_lambda: float,
        route_ts_prompt_weight: float,
        route_ts_semantic_weight: float,
        graph_enable: bool,
        rho: float,
        loss_type: str,
        loss_weight: float,
        ...
        opts = [
            "MODEL.PROMPT.BACKEND", prompt_backend,
            ...
            "SOLVER.LOSS_ROUTE_TS_PROMPT_WEIGHT", str(route_ts_prompt_weight),
            "SOLVER.LOSS_ROUTE_TS_SEMANTIC_WEIGHT", str(route_ts_semantic_weight),
        ...
        trials.append(
            {
                ...
                "affinity_evolution_enable": affinity_evolution_enable,
                "prompt_lambda": prompt_lambda,
                "semantic_lambda": semantic_lambda,
                "route_ts_prompt_weight": route_ts_prompt_weight,
                "route_ts_semantic_weight": route_ts_semantic_weight,
                "opts": opts,
            }
        )
                ...
                for prompt_stat_source in ["mu", "instance_mean"]:
                    for prompt_mode in prompt_modes:
                        _add_trial(
                            ...
                            use_slot_embed=use_slot_embed,
                            prompt_stat_source=prompt_stat_source,
                            prompt_mode=prompt_mode["name"],
                            prompt_backend=prompt_mode["backend"],
                            affinity_evolution_enable=prompt_mode["affinity"],
                            prompt_lambda=prompt_mode["prompt_lambda"],
                            semantic_lambda=prompt_mode["semantic_lambda"],
                            route_ts_prompt_weight=prompt_mode["route_prompt"],
                            route_ts_semantic_weight=prompt_mode["route_semantic"],
                            graph_enable=True,
                            rho=1.0,
                            loss_type=loss_type,
        ...
        for loss_type in ["acc_hidden", "rel_kl", "rel_all", "ot", "fgw"]:
            for stats_hidden_dim in [32, 64, 128]:
                _add_trial(
                    ...
                    prompt_mode="base_dynamic_affinity",
                    prompt_backend="dynamic",
                    affinity_evolution_enable=True,
                    prompt_lambda=0.0,
                    semantic_lambda=0.0,
    ...
    search_space = {
        ...
        "sweep": [
            ...
            "MODEL.AFFINITY_EVOLUTION.ENABLE",
        ...
        "fixed_setting": {
            ...
            "MODEL.SEMANTIC_TOKENS.ORTHO.GROUP_MODE": "manual_cub8",
            "MODEL.SEMANTIC_TOKENS.ORTHO.TEXT_MODE": "null_residual",
            "MODEL.AFFINITY_EVOLUTION.ENABLE": "trial_specific",
            "MODEL.AFFINITY_EVOLUTION.PROMPT_LAMBDA": "trial_specific",
            "MODEL.AFFINITY_EVOLUTION.SEMANTIC_LAMBDA": "trial_specific",
            "SOLVER.LOSS_ATTR_WEIGHT": 0.001,
            "SOLVER.ATTR.METRIC": "mse",
            "SOLVER.LOSS_SEM_MED_WEIGHT": 0.0,
            "SOLVER.LOSS_SPV_WEIGHT": 0.0,
            "SOLVER.LOSS_ROUTE_TS_PROMPT_WEIGHT": "trial_specific",
            "SOLVER.LOSS_ROUTE_TS_SEMANTIC_WEIGHT": "trial_specific",
        },
    ...
    def _build_trial(idx: int, trial: Dict[str, object], gpu_id: str = ""):
        ...
        row: Dict[str, object] = {
            ...
            "affinity_evolution_enable": trial["affinity_evolution_enable"],
