...
def write_trainable_parameter_manifest(cfg, model) -> Optional[str]:
    ...
    payload = {
        ...
        "classifier_score_mode": str(cfg.MODEL.R_SIMILARITY.SCORE_MODE),
        "classifier_learnable_scale": bool(cfg.MODEL.R_SIMILARITY.LEARNABLE_SCALE),
        "classifier_fixed_logit_scale": float(cfg.MODEL.R_SIMILARITY.FIXED_LOGIT_SCALE),
