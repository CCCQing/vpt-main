...
MONITOR_SPECS: Tuple[MonitorSpec, ...] = (
    ...
    MonitorSpec(
        ...
        artifact="step_jsonl",
        sampling="global_step",
        description="trainer and loss debug scalars",
    ...
    MonitorSpec(
        ...
        artifact="events_jsonl",
        sampling="on_event",
        description="optimizer membership, gradients, and first update evidence",
    ...
    MonitorSpec(
        ...
        artifact="events_jsonl",
        sampling="on_event",
        description="evaluation split access and declared purpose",
        source_requirement="evaluation pass",
        is_requested=_always,
        is_source_active=_always,
    ),
    MonitorSpec(
    ...
    MonitorSpec(
        ...
        artifact="epoch_csv",
        sampling="every_epoch",
        description="joint-space seen bias, confidence, entropy, margin, and rank",
    ...
    MonitorSpec(
        ...
        artifact="epoch_csv",
        sampling="every_epoch",
        description="class-error scalar summary with vector artifacts managed by diagnostics",
        source_requirement="completed evaluator pass",
    ...
    MonitorSpec(
        ...
        artifact="epoch_csv",
        sampling="every_epoch",
        description="fixed-grid final_gzsl calibrated-stacking diagnostic summary",
